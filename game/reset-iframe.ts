...
const abilities = [
  { name: 'heal_after_battle', cost: 30, description: 'Heal a small amount after each battle' },
  { name: 'starting_element', cost: 35, description: 'Start your adventure wtih a random elemental type'},
